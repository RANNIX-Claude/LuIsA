...
SELECT
  ...
  75
FROM usuarios_luisa ul WHERE ul.rol = 'paciente';
...
SELECT 'LUISA v2.0 - BD CREADA COMPLETAMENTE' as resultado;

SELECT
  'Médicos' as entidad, COUNT(*) as total FROM medicos
UNION ALL SELECT 'Pacientes', COUNT(*) FROM perfiles_pacientes
UNION ALL SELECT 'Usuarios Luisa', COUNT(*) FROM usuarios_luisa
